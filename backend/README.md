...
## Project Structure
    ...
    ├── testapiautodatamod_113200  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_113200`
...
2. Clone this repo and `cd testapiautodatamod_113200`
